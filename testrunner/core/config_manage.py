...
from testrunner.utils import file_helper
from testrunner.utils.dsl_helper import return_value, str2bool
from testrunner.utils.file_helper import read_json_data
...
class ConfigManage:
    ...
    def __init__(self, user_data):
        ...
        logger.info("APP configuration information", str(self.app_info.__dict__))
...
class WebConfig:
    ...
    def __init__(self, user_data, config):
        ...
        if user_data is None and web_info is None:
            logger.warning('[web_info] configuration of web_info is none.')
...
class SchemaUrl:
    ...
    def __init__(self):
        ...
        if os.path.exists(schema_url_path):
            ...
            logger.warning(f"[SchemaUrl] cannot find path: {schema_url_path}")
