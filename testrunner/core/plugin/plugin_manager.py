...
from testrunner.core.plugin.plugin_proxy import PluginProxy
...
def append_prex(name, sub_pkg):
    ...
    append default pkg
    """
    return "testrunner.core.plugin.plugins." + sub_pkg + "." + name
...
def append_event_prex(name, sub_pkg):
    ...
    append default pkg
    """
    return "testrunner.core.plugin." + sub_pkg + "." + name
    ...
    def find_default_dir(self, plugins, group):
        ...
        for d_n in self.directories:
            try:
                ...
                logger.info(f"do not exist path: {d_n}")
                continue
